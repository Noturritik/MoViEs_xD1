...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡𝐌𝐀𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋⚡', url='https://telegram.me/MoViEs_xD1')
            ],
            [
                InlineKeyboardButton('⚡𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐆𝐑𝐎𝐔𝐏⚡', url=f"https://telegram.me/cHATING_xD"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡𝐌𝐀𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋⚡', url=f"https://telegram.me/real_MoviesAdda1"),
            InlineKeyboardButton('❤️𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐆𝐑𝐎𝐔𝐏❤️', url='https://t.me/cHATING_XD')
            ],[
             InlineKeyboardButton('💥𝐒𝐔𝐏𝐏𝐎𝐑𝐓💥', url='https://t.me/ritikk_xd'),
            InlineKeyboardButton('💥𝐎𝐖𝐍𝐄𝐑️', url='https://t.me/Not_hurted_anymore')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🔥 Join Updates Channel 🔥", url=https://t.me/Movies_xd1
                )
            ]
        ]
